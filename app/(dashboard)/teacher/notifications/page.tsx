      ...
      const mockNotifications: NotificationData[] = [
        {
          ...
          content: 'Sinh viên Trần Văn A đã trả lời bài viết của bạn: "Hướng dẫn lập trình Java"',
          is_read: false,
          created_at: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
          actor: { user_id: 2, full_name: 'Trần Văn A' }
        },
        {
          notification_id: 2,
          type: 'assignment_graded',
          title: 'Sinh viên nộp bài',
          content: 'Sinh viên Nguyễn Thị B đã nộp bài tập "Assignment 3: Database Design".',
          is_read: false,
          created_at: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(),
          actor: { user_id: 3, full_name: 'Nguyễn Thị B' }
        },
        {
          notification_id: 3,
          type: 'system',
          title: 'Thông báo hệ thống',
          content: 'Bạn có 5 bài tập chưa chấm điểm. Vui lòng kiểm tra và chấm điểm.',
          is_read: true,
