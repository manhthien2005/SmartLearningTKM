...
export default function TeacherSettingsPage() {
  ...
  const settingsSections = [
    ...
    },
    {
      ...
      description: 'Cài đặt liên quan đến giảng dạy',
      color: 'emerald'
    },
    {
      id: 'privacy',
        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between group hover:bg-gray-50 p-3 rounded-lg transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Khi sinh viên trả lời bài viết của bạn</p>
              </div>
            </div>
            <ToggleSwitch
          ...
          <div className="flex items-center justify-between group hover:bg-gray-50 p-3 rounded-lg transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900">Sinh viên nộp bài</h4>
                <p className="text-sm text-gray-600">Khi sinh viên nộp bài tập</p>
              </div>
            </div>
            <ToggleSwitch
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case 'teaching':
        return renderComingSoonSection('Quản lý giảng dạy');
      case 'privacy':
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Quản lý tài khoản và tùy chỉnh trải nghiệm giảng dạy của bạn</p>
      </div>
